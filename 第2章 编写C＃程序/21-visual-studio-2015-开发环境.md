...
选择` 解决方案资源管理器 `窗口中的需要卸载的项目，然后在鼠标右键菜单中选择` 卸载项目 `选项，如图2-9所示。
...
选择` 解决方案资源管理器 `窗口中的需要卸载的项目，然后在鼠标右键菜单中选择` 删除 `选项，如图2-10所示。
...
选择` 解决方案资源管理器 `窗口中的需要卸载的项目，然后在鼠标右键菜单中选择` 删除 `选项，如图2-11所示。
