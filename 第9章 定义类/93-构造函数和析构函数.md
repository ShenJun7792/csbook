...
```javascript public class MyDerivedClass : MyBaseClass { public MyDerivedClass() : base(5) { } ... }```
...
```javascript public class MyDerivedClass : MyBaseClass { public MyDerivedClass() : this(5, 6) { } ... public MyDerivedClass (int i, int j) : base(i) { } }```
...
```javascript public class MyBaseClass { public MyBaseClass() : this(5) { }
